...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FD] p-6 md:p-12  relative overflow-hidden flex items-center justify-center">
      <Toaster
        toastOptions={{
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="flex items-center gap-2 text-purple-500 mb-2">
                <FiClock />
                <span className="text-xs font-bold uppercase">Last Update</span>
              </div>
              <div>
                <h3 className="text-xl font-bold text-gray-800">
                  {user.formattedUpdate}
                </h3>
                <p className="text-xs text-gray-400">Profile details updated</p>
              </div>
            </motion.div>
          </div>
